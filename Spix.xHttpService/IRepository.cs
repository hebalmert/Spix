...
{
    Task<HttpResponseWrapper<DownloadFileDTO>> GetDownloadUrlAsync(string container, string file, string nameOriginal);
    ...
    Task<HttpResponseWrapper<T>> GetAsync<T>(string url, CancellationToken token);
