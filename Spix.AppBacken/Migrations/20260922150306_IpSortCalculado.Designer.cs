...
namespace Spix.AppBacken.Migrations
{
    ...
    [Migration("20260922150306_IpSortCalculado")]
    partial class IpSortCalculado
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Spix.Domain.EntitiesNet.IpNet", b =>
                {
                    ...
                    b.Property<long?>("IpSort")
                        ...
                        .HasColumnType("bigint")
                        .HasComputedColumnSql("TRY_CAST(PARSENAME([Ip], 4) AS bigint) * 16777216 + TRY_CAST(PARSENAME([Ip], 3) AS bigint) * 65536 + TRY_CAST(PARSENAME([Ip], 2) AS bigint) * 256 + TRY_CAST(PARSENAME([Ip], 1) AS bigint)", false);
