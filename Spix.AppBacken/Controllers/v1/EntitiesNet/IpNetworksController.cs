...
{
    private readonly IIpNetworkServiceX _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public IpNetworksController(
        IIpNetworkServiceX unitOfWork,
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(IpNetwork modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetSecurityContextOrThrow(_localizer, HttpContext);
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(IpNetwork modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetSecurityContextOrThrow(_localizer, HttpContext);
