...
{
    private readonly IProductCategoryServiceX _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public ProductCategoriesController(IProductCategoryServiceX productCategoryUnitOfWork, IStringLocalizer localizer)
    {
        _unitOfWork = productCategoryUnitOfWork;
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(ProductCategory modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(ProductCategory modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer, HttpContext);
