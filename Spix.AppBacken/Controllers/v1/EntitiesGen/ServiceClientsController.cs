...
{
    private readonly IServiceClientServiceX _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public ServiceClientsController(IServiceClientServiceX serviceClientUnitOfWork, IStringLocalizer localizer)
    {
