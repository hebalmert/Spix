...
{
    private readonly IRegisterServiceX _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public RegistersController(IRegisterServiceX registerUnitOfWork, IStringLocalizer localizer)
    {
        _unitOfWork = registerUnitOfWork;
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(Register modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(Register modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer, HttpContext);
