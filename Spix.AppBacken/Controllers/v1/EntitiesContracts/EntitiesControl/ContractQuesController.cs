...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/contractques")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator, Auxiliar")]
[ApiController]
public class ContractQuesController : ControllerBase
{
    private readonly IContractQueServiceX _serverUnitOfWork;
    private readonly IStringLocalizer _localizer;

    public ContractQuesController(IContractQueServiceX serverUnitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<ContractQue>> PostAsync(ContractQue modelo)
    {
