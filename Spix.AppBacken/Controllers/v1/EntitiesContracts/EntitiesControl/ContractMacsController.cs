...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/contractmacs")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator, Auxiliar")]
[ApiController]
public class ContractMacsController : ControllerBase
{
    private readonly IContractMacServiceX _serverUnitOfWork;
    private readonly IStringLocalizer _localizer;

    public ContractMacsController(IContractMacServiceX serverUnitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<ContractMac>> PostAsync(ContractMac modelo)
    {
