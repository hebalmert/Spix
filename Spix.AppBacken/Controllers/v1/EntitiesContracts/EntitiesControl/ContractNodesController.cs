...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/contractnodes")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator, Auxiliar")]
[ApiController]
public class ContractNodesController : ControllerBase
{
    private readonly IContractNodeServiceX _serverUnitOfWork;
    private readonly IStringLocalizer _localizer;

    public ContractNodesController(IContractNodeServiceX serverUnitOfWork, IStringLocalizer localizer)
    {
