...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/contractplans")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator, Auxiliar")]
[ApiController]
public class ContractPlansController : ControllerBase
{
    private readonly IContractPlanServiceX _serverUnitOfWork;
    private readonly IStringLocalizer _localizer;

    public ContractPlansController(IContractPlanServiceX serverUnitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<ContractPlan>> PostAsync(ContractPlan modelo)
    {
