...
{
    private readonly ICargueDetailsServiceX _cargueDetailsUnitOfWork;
    private readonly IStringLocalizer _localizer;

    public CargueDetailsController(ICargueDetailsServiceX cargueDetailsUnitOfWork, IStringLocalizer localizer)
    {
