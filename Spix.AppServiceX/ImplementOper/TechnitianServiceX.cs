...
public class TechnitianServiceX : ITechnitianServiceX
{
    ...
    public async Task<ActionResponse<bool>> ResendActivationEmailAsync(Guid id, string frontUrl, string username) => await _technitianService.ResendActivationEmailAsync(id, frontUrl, username);
