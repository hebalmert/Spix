...
public class UsuarioServiceX : IUsuarioServiceX
{
   ...
   public async Task<ActionResponse<IEnumerable<GuidItemModel>>> ComboAsync(string username) => await _usuarioService.ComboAsync(username);
    ...
    public async Task<ActionResponse<bool>> ResendActivationEmailAsync(Guid id, string urlFront, string username) => await _usuarioService.ResendActivationEmailAsync(id, urlFront, username);
