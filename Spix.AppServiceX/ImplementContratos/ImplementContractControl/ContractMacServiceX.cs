...
public class ContractMacServiceX : IContractMacServiceX
{
    private readonly IContractMacService _contractService;

    public ContractMacServiceX(IContractMacService contractService)
    {
        _contractService = contractService;
    }

    public async Task<ActionResponse<ContractMac>> GetAsync(Guid id) => await _contractService.GetAsync(id);
