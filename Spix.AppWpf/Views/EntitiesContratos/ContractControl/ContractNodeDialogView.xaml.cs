...
// El nodo de acceso de un contrato.
public partial class ContractNodeDialogView : UserControl, ISharedModalContent
{
    private readonly ContractNodeDialogViewModel _viewModel;
    private Guid _id;
    private bool _loaded;

    public ContractNodeDialogView(ContractNodeDialogViewModel viewModel)
    {
        InitializeComponent();
