...
public partial class InputImageIDfront : IAsyncDisposable
{
    ...
    private async Task CaptureImage()
    {
        try
        {
            var base64 = await JS.InvokeAsync<string>("camaraIdPicFront.takePhoto");
    ...
    private async Task ToggleCamera()
    {
        ...
        await JS.InvokeVoidAsync("camaraIdPicFront.startCamera");
    }
    ...
    {
        await JS.InvokeVoidAsync("camaraIdPicFront.loadFromFile", DotNetObjectReference.Create(this));
    }
