...
public partial class IndexBillingNote
{
    ...
    private async Task LoadAsync(int page = 1)
    {
        ...
        var responseHttp = await _repository.GetAsync<List<BillingNote>>(url);
        if (await _responseHandler.HandleErrorAsync(responseHttp))
        {
        ...
        BillingNotes = responseHttp.Response;
