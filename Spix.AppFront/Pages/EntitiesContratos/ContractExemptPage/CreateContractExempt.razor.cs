...
//Exonerar un contrato desde el modulo. Llama al endpoint PROPIO de exoneracion:
//cada modulo maneja sus reglas, no se comparten con Control de Contratos.
public partial class CreateContractExempt : IDisposable
{
    ...
    private async Task SaveAsync()
    {
        ...
        {
            Title = Localizer["Exempt_Title"],
            Text = Localizer["Exempt_Question", Selected.ControlContrato, Selected.ClientName],
            Icon = SweetAlertIcon.Question,
            ShowCancelButton = true,
            ConfirmButtonText = Localizer["Exempt_Button"],
