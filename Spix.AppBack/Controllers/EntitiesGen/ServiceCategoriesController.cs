...
{
    private readonly IServiceCategoryUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public ServiceCategoriesController(IServiceCategoryUnitOfWork serviceCategoryUnitOfWork, IStringLocalizer localizer)
    {
