...
{
    private readonly IMarkUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public MarksController(IMarkUnitOfWork markUnitOfWork, IStringLocalizer localizer)
    {
        _unitOfWork = markUnitOfWork;
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(Mark modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(Mark modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer, HttpContext);
