...
{
    private readonly IMarkModelUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public MarkModelsController(IMarkModelUnitOfWork markModelUnitOfWork, IStringLocalizer localizer)
    {
        _unitOfWork = markModelUnitOfWork;
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(MarkModel modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(MarkModel modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer);
