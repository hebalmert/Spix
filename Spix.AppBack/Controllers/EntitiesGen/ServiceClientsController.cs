...
{
    private readonly IServiceClientUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public ServiceClientsController(IServiceClientUnitOfWork serviceClientUnitOfWork, IStringLocalizer localizer)
    {
        _unitOfWork = serviceClientUnitOfWork;
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(ServiceClient modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(ServiceClient modelo)
    {
        try
        {
            ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer, HttpContext);
